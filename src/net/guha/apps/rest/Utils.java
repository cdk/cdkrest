...
public class Utils {
     ...
     * <p/>
     * This can be used to obtain the names of the descriptors and then evaluate a subset of them. It is possible to
     * obtain the names of descriptors from specifc classes, depending on the value of the argument.
     * <p/>
     * <b>Note</b>: For now we ignore the protein descriptors.
     *
     * @param type May have the values of: "", "all", "topological", "geometrical", "constitutional", "electronic",
     *             "hybrid". If an empty string or 'all" is specified, then all available descriptor names are
     *             returned.
     ...
     *
     * @param str A string representing the molecule. Can be a SMILES, Base64 encoded SMILES or an SDF. Note that it
     *            assumes the string has been decoded from the URL encoded form
     * @return The molecule
