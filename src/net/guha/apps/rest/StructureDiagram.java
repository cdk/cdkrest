...
public class StructureDiagram {
    ...
    private IAtomContainer getNeedle(IAtomContainer target, String query) throws CDKException {
        ...
        IAtomContainer ret = target.getBuilder().newInstance(IAtomContainer.class);
    ...
    public byte[] getDiagram(IAtomContainer molecule, String ssquery,
        ...
        try {
            ...
            Renderer2DPanel panel = new Renderer2DPanel(mol2d, width, height);
            frame = new JFrame();
            frame.getContentPane().add(panel);
            frame.pack();
            bytes = panel.getBytes(width, height);
